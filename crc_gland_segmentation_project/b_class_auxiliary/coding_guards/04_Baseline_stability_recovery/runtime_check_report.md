...
- experiment_config: `configs/experiment/A2_UNet_GlaS_seed3407.yaml`
...
- train_config_exists: `pass` -> `configs/train/unet_flow_v2.yaml`
...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/A2_UNet_GlaS_seed3407.yaml --run-name A2_UNet_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/04_Baseline_stability_recovery/train_runtime_payload.json --device cuda --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/04_Baseline_stability_recovery/runtime_check.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/04_Baseline_stability_recovery/runtime_evidence.json`
