...
- experiment_config: `configs/experiment/D2_R34UNet_Distance_GlaS_seed3407.yaml`
- run_name: `D2_R34UNet_Distance_GlaS_seed3407`
- stage_code: `D2_Distance`
- dataset_code: `glas`
- model_code: `resnet34_unet_distance`
...
- model_config_exists: `pass` -> `configs/model/resnet34_unet_distance.yaml`
...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/D2_R34UNet_Distance_GlaS_seed3407.yaml --run-name D2_R34UNet_Distance_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/07_Distance/train_runtime_payload.json --device cuda --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/07_Distance/runtime_check.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/07_Distance/runtime_evidence.json`
...
- loss_finite_pass: pass (loss_value=1.3102675676345825 and loss_is_finite=True)
