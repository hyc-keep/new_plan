...
- experiment_config: `configs/experiment/full_chain_reproduction/A1_UNet_GlaS_seed3407_chain.yaml`
- run_name: `A1_UNet_GlaS_seed3407_chain`
- stage_code: `A1`
- dataset_code: `glas`
- model_code: `unet_flow`
...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/full_chain_reproduction/A1_UNet_GlaS_seed3407_chain.yaml --run-name A1_UNet_GlaS_seed3407_chain__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/01_04_full_chain_reproduction/01_train_runtime_payload.json --device cuda --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/01_04_full_chain_reproduction/01_runtime_check.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/01_04_full_chain_reproduction/01_runtime_evidence.json`
