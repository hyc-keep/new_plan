...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/B1_ResNet34_UNet_GlaS_seed3407.yaml --run-name B1_ResNet34_UNet_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/04_Baseline/train_runtime_payload.json --device cuda --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/04_Baseline/runtime_check.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/04_Baseline/runtime_evidence.json`
