...
- experiment_config: `configs/experiment/B1_ResNet34_UNet_GlaS_seed3407.yaml`
- run_name: `B1_ResNet34_UNet_GlaS_seed3407`
- stage_code: `B1`
- dataset_code: `glas`
...
- model_config_exists: `pass` -> `configs/model/resnet34_unet.yaml`
...
- model_module: `pass` -> `src/models/resnet34_unet.py` (implemented)
...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/B1_ResNet34_UNet_GlaS_seed3407.yaml --run-name B1_ResNet34_UNet_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/04_Baseline/train_runtime_B1_original_protocol.json --device cpu --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/04_Baseline/runtime_check_B1_original_protocol.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/04_Baseline/runtime_evidence_B1_original_protocol.json`
...
- loss_finite_pass: pass (loss_value=1.2935928106307983 and loss_is_finite=True)
