...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/A2_UNet_GlaS_seed3407.yaml --run-name A2_UNet_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output experiments/reproducibility_audit/02_unet_flow/train_runtime_payload_37bf9fb.json --device cuda --max-steps 1`
- runtime_log: `experiments/reproducibility_audit/02_unet_flow/runtime_check_37bf9fb.log`
- runtime_evidence_json: `experiments/reproducibility_audit/02_unet_flow/runtime_evidence_37bf9fb.json`
