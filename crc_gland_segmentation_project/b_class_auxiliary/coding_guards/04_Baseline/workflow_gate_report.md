...
- required_artifact: `reports/stage_reports/implementation_tracking/04_Baseline_original_protocol_reproduction/实现依据记录.md`
...
- return_code: `0`
- command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/b_class_auxiliary/tools/check_precheck_docs.py --project-root /home/featurize/work/Paper/crc_gland_segmentation_project --precheck-guard b_class_auxiliary/coding_guards/04_Baseline/04_Baseline_pre_check_guard.md --output b_class_auxiliary/coding_guards/04_Baseline/precheck_doc_gate_report.md`
...
- return_code: `0`
- command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/b_class_auxiliary/tools/check_code_quality_gate.py --project-root /home/featurize/work/Paper/crc_gland_segmentation_project --post-qc-guard b_class_auxiliary/coding_guards/04_Baseline/04_Baseline_post_qc_guard.md --output b_class_auxiliary/coding_guards/04_Baseline/code_quality_gate_report.md`

### numbered_stage_gate
- status: `not_applicable`
- reason: `numbered_stage_gate_not_required:04_Baseline_original_protocol_reproduction`
- output_path: `None`
- return_code: `None`
- command: `blocked`
