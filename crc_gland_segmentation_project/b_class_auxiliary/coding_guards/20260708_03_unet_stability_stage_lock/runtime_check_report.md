...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/A2_UNet_GlaS_v1_seed3407.yaml --run-name A2_UNet_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/20260708_03_unet_stability_stage_lock/train_runtime_payload.json --device cuda --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/20260708_03_unet_stability_stage_lock/runtime_check.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/20260708_03_unet_stability_stage_lock/runtime_evidence.json`
