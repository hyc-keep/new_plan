...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/A2_UNet_GlaS_seed3407.yaml --run-name A2_UNet_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/04_Baseline/train_runtime_A2_original_protocol.json --device cpu --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/04_Baseline/runtime_check_A2_original_protocol.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/04_Baseline/runtime_evidence_A2_original_protocol.json`
...
- loss_finite_pass: pass (loss_value=1.271264910697937 and loss_is_finite=True)
