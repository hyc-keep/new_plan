...
- `D:/12_Medical_Image_Segmentation/Paper/.trae/skills/crc-gland-research-alignment/SKILL.md`
- `D:/12_Medical_Image_Segmentation/Paper/.trae/skills/crc-gland-learning-doc/SKILL.md`
- `.trae/skills/制度完成定义.md`
- `.trae/skills/00_技能体系导航.md`
- `tools/README.md`
...
- `D:/12_Medical_Image_Segmentation/Paper/结直肠腺体分割_正式参考资料/04_正式工程代码映射清单.md`
