...
- runtime_command: `/environment/miniconda3/bin/python /home/featurize/work/Paper/crc_gland_segmentation_project/scripts/train.py --config configs/experiment/B1_ResNet34_UNet_GlaS_seed3407.yaml --run-name B1_ResNet34_UNet_GlaS_seed3407__runtime_probe --runtime-check --runtime-check-output b_class_auxiliary/coding_guards/04_Baseline/train_runtime_cpu_debug_payload.json --device cpu --max-steps 1`
- runtime_log: `b_class_auxiliary/coding_guards/04_Baseline/runtime_cpu_debug.log`
- runtime_evidence_json: `b_class_auxiliary/coding_guards/04_Baseline/runtime_cpu_debug_evidence.json`
...
- loss_finite_pass: pass (loss_value=1.2935926914215088 and loss_is_finite=True)
